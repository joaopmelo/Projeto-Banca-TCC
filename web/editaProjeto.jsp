<%-- 
    Document   : editaProjeto
    Created on : 27/08/2018, 00:34:20
    Author     : jpedro
--%>
...
<html>
    ...
    <body>
        ...
        <%@include file="/navbar.jsp" %>
            ...
            <div id="top">
                <center><h1>Cadastro de Projeto - Editar</h1></center>
            </div> 
            ...
            <div id="leftSide">
                ...
                <%
                    ...
                    try {
                     ...
                     idProj = Integer.parseInt(request.getParameter("idProj"));

                    } catch (Exception e) {
                        throw new RuntimeException("<center><font face='verdana' "
                                + "color='red'size='2'>"
                                + "Erro ao tentar localizar os dados do Projeto"
                                + "</font></center>");
                    }
                    //pegar o objeto pelo id
                    proj = Sproj.buscaPorIdProjeto(idProj);

                %>

                <form name = "frmEditaProjeto" method="POST" action="Alterar_projeto">
                    ...
                    <fieldset>
                        ...
                        <input type="hidden" name="id_proj" value="<%out.print(proj.getId());%>"> 
                        
                        <label for="titulo"> Titulo do Projeto:</label>
                        <div class="div_texbox">
                            <input name="titulo" type="text" class="usuario" value="<%out.print(proj.getTitulo());%>"/>
                        </div>
                        ...
                        <div class="div_texbox">
                            <%                                
                                ...
                                out.print("<option seleted>Selecione o curso</option>");
