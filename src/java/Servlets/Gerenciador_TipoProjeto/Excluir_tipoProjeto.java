 ...
 * @author jpedro
 */
public class Excluir_tipoProjeto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int id_teste = 3;
                ...
                tipoProjeto.setId(id_teste);

                try {
                    tipoProjetoDao.remove(tipoProjeto);
                    out.println("<h2>Aluno - id: "+tipoProjeto.getId()+" removido com sucesso!</h2>");
